...
// cors站点数据
const corsPoints = [
  { name: "BAOX", type: "cors站", longitude: 102.823369242, latitude: 30.247992642, altitude: 752.328, antenna: "TRM57971.00", port: 10291, ip: "127.16.34.9", Hardpoint: "BAOX", imageUrl: "images/15.png" },
  ...
  { name: "TIAQ", type: "cors站", longitude: 102.763995389, latitude: 30.074583769, altitude: 753.765, antenna: "TRM59900.00", port: 10608, ip: "127.16.34.9", Hardpoint: "TIAQ", imageUrl: "images/14.png" },
  ...
  { name: "YINJ", type: "cors站", longitude: 102.760572356, latitude: 29.764649397, altitude: 753.8143, antenna: "TRM57971.00", port: 10324, ip: "127.16.34.9", Hardpoint: "YINJ", imageUrl: "images/11.png" }
];
...
function addMarkers(points, iconUrl) {
  points.forEach(point => {
    ...
    marker.on('click', function (e) {
      ...
      // 更新图片盒子
      const dynamicImage = document.getElementById('dynamicImage2');
      if (dynamicImage) {
        dynamicImage.src = point.imageUrl || dynamicImage.dataset.src; // 如果没有 imageUrl，使用默认图片
      }
    });
    marker.setMap(map);
  });
